...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, x='Year',y='Automobile_Sales',title= "Monthly Automobile Sales per Year".format(input_year)))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_vdata,values= 'Advertising_Expenditure', names= 'Vehicle_Type',title='Total Expenditure by Vehicle Type'))

#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                html.Div(className='chart-item', children=[html.Div(Y_chart1),html.Div(Y_chart2)],style={flex}),
                html.Div(className='chart-item', children=[html.Div(Y_chart3),html.Div(Y_chart4)],style={flex})
                ]
